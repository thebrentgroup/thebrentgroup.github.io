...
The file cell_id_1.1.tar.gz contains the source code for cell_id.
The file cell_id_1.1_no_example_images.tar.gz is identical but does
not contain any sample images (and so is signficantly smaller)
...
tar -zxvf cell_id_1.1_no_example_images.tar.gz
...
example/ --> An example of some images from an experiment and a PAW-readable
             database file (only for cell_id_1.1.tar.gz).
